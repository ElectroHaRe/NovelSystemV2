namespace BaseWFControlNovelLibrary
{
    ...
    partial class FieldElement
    {
        ...
        public new string Text { get => textBox.Text; set => (this as BaseNovelLibrary.INode).ChangeText(value); }
        public System.Drawing.Image Image { get => pictureBox.Image; set => (this as BaseNovelLibrary.INode).ChangeImage(value); }
