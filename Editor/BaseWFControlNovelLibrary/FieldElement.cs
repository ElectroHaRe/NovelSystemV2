...
namespace BaseWFControlNovelLibrary
{
    ...
    public partial class FieldElement : UserControl, IFieldElement, ISerializable
    {
        ...
        Image INode.Image => pictureBox.Image;
        string INode.Text => textBox.Text;
        ...
        void INode.ChangeImage(Image @new)
        {
        ...
        void INode.ChangeText(string @new) => textBox.Text = @new;
        ...
        {
            (this as INode).ChangeImage(info.GetValue("image", typeof(Image)) as Image);
            (this as INode).ChangeText(info.GetValue("text", typeof(string)) as string);
